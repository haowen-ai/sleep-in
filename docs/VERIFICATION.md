...
The final local suite passed **80 tests**, with one PostgreSQL-only test skipped because local PostgreSQL was not configured. The [Linux test job](https://github.com/haowenchen0811/n8n-task-console/actions/runs/35282367674) passed with PostgreSQL configured.
